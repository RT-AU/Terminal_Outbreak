...
namespace Terminal_Outbreak.Scenes
{
    internal class TitleScene : Scene
    {
        ...
        public override void Run()
        {
            ...
            string display = ($"In a world ravaged by an unknown plague, society has crumbled, and the streets teem with the undead. {Environment.NewLine}As a survivor, you must navigate through the chaos, scavenge for resources, and fight to stay alive. {Environment.NewLine}{Environment.NewLine}Welcome to Terminal Outbreak. (Use the Arrow Keys to cycle through options and Enter to select){Environment.NewLine}");
