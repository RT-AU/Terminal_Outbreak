...
namespace Terminal_Outbreak.Scenes.Trading
{
    internal class TradeMeleeScene : Scene
    {
        ...
        public override void Run()
        {
            ...
            {
                display = Utils.WrapText($"{Environment.NewLine}There are no more melee weapons available.{Environment.NewLine}");
            }
            else
            {
                display = Utils.WrapText($"{Environment.NewLine}There are a range of melee weapons that you can buy. You currently have {baseRationsCount} Rations.{Environment.NewLine}");
            }
