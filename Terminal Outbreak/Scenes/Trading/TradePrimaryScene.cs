...
{
    internal class TradePrimaryScene : Scene
    {
        
        public TradePrimaryScene(TerminalOutbreakGame game) : base(game)
        {
        ...
        public override void Run()
        {
            ...
            {
                display = Utils.WrapText($"{Environment.NewLine}There are no more primary weapons available.{Environment.NewLine}");
            }
            else
            {
                display = Utils.WrapText($"{Environment.NewLine}There are a range of primary weapons that you can buy. You currently have {baseRationsCount} Rations.{Environment.NewLine}");
            }
